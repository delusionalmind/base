    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                @if($errors->any())
                    <div class="card-header text-center text-danger">{{$errors->first()}}</div>
                @endif
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="identity" class="col-md-4 col-form-label text-md-right">{{ __('Username / E-Mail Address') }}</label>
